...
//
// Chỉ cho tự sửa họ tên hiển thị. Tên đăng nhập, vai trò và trạng thái tài
// khoản đều cố định — chúng thuộc quyền của quản trị viên.
 ...
 * @param {(hoSo: object) => void} [props.onSaved] - gọi sau khi lưu thành công
 */
        ...
        {dangTai ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6" noValidate>
            ...
            <p className="text-xs text-slate-400">
              Tên đăng nhập và vai trò do quản trị viên quản lý, bạn không tự đổi
              được.
            </p>
            ...
            <div>
              ...
              {errors.ho_ten ? (
                ...
                <span className="mt-1 block text-xs text-slate-400">
                  Tên này hiện ở lời chào, cột Phụ trách và danh sách nhân viên.
                  Để trống thì hệ thống hiện tên đăng nhập.
                </span>
              )}
            </div>
